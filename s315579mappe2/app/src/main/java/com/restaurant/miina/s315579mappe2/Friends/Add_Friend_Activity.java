...
//            return;
//
//        friend = new Restaurant(name.getText().toString(),phone.getText().toString(),address.getText().toString(),type.getText().toString());
//        db.regRestaurant(friend);
//
//        setResult(RESULT_OK);
//        finish();
//    }
...
//        }
//
//        friend = new Restaurant(id, name.getText().toString(),phone.getText().toString(),address.getText().toString(),type.getText().toString());
//        db.updateRestaurant(friend);
//
//        setResult(RESULT_OK);
//        finish();
